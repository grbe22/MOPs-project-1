...
file: array_heap.py
language: python3.7 (requires dataclasses)
author: CS @ RIT.EDU
"""
...
def testHeap( testData ):
    """
    testHeap : ListOfComparable -> NoneType
...
def heapSort( testData, compFunc ):
    """
    heapSort : ListOfComparable Function -> SortedListOfComparable
    Create a min heap, fill it with the test data, and
    remove it, returning a sorted collection
    """
    lst = []
    heap = createEmptyHeap( len(testData), compFunc)
...
if __name__ == '__main__':
    ...
    print( "Displaying the heap as a tree..." )
    testData = (1, 3, 5, 7, 9, 10, 8, 6, 4, 2, 0)     # Test data
    testHeap( testData )

    print( "Sorting..." )
    data = [ 'able', 'was', 'I', 'ere', 'I', 'saw', 'Abel' ]
    print( "unsorted: ", data )
    sortedList = heapSort( data, less )
    print( "ascending sorted: ", sortedList )
    sortedList = heapSort( data, greater )
    print( "descending sorted: ", sortedList )
